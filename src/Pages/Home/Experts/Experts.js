...
const experts = [
    { id: 1, name: 'abdul', img: expert1 },
    { id: 2, name: 'bodrul', img: expert2 },
    { id: 3, name: 'cardi', img: expert3 },
    { id: 4, name: 'dwayne', img: expert4 },
    { id: 5, name: 'fardin', img: expert5 },
    { id: 6, name: 'ema', img: expert6 }]
const Experts = () => {
    return (
